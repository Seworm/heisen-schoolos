      ...
      <div className="mt-6 grid gap-6 lg:grid-cols-2">
        ...
        <section className="rounded-xl border border-slate-200 bg-white shadow-sm">
          ...
          <dl className="divide-y divide-slate-100">
            ...
            <div className="grid grid-cols-2 gap-4 px-6 py-4">
              <dt className="text-sm text-slate-500">Middle name</dt>
              <dd className="text-right text-sm font-medium text-slate-900">
                {student.middleName || "—"}
              </dd>
            </div>
        ...
        <section className="rounded-xl border border-dashed border-slate-300 bg-slate-50 lg:col-span-2">
          <div className="px-6 py-6">
            ...
            <p className="mt-1 max-w-2xl text-sm leading-6 text-slate-500">
              Enrollment, attendance, assessments, fees, and report
              cards will be connected to this student profile as those
