  ...
  return <main className="space-y-8 p-6 lg:p-8">
    ...
    <section className="rounded-xl border bg-card p-6">
      ...
      <form method="get" className="mt-4 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="flex items-end gap-2"><button className="rounded-lg bg-primary px-4 py-2 text-sm font-medium text-primary-foreground">Apply filters</button><Link href="/finance/cashbook" className="rounded-lg border px-4 py-2 text-sm font-medium">Clear</Link></div>
      </form>
    </section>
    <section className="rounded-xl border bg-card p-6">
