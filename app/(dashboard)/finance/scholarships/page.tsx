...
export default async function ScholarshipsPage() {
  ...
  const termsForYear = await db.select({ id: terms.id, name: terms.name, academicYearId: terms.academicYearId, yearName: academicYears.name }).from(terms).innerJoin(academicYears, eq(academicYears.id, terms.academicYearId)).where(eq(academicYears.schoolId, school.id)).orderBy(desc(academicYears.startDate), asc(terms.termNumber));
